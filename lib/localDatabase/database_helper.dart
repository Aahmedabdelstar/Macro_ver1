...
//    await deleteDatabase(path); // just for testing
  ...
  Future<int> addOrderForCustomer(String orderId, String regionID,
      String totalSalary, String orderDate) async {
  ...
  Future<int> addProductIntoBasket(String productId, String category,
      int quantity) async {
  ...
  Future<int> incrementProductInBasket(String productId,
  ...
  Future<int> decrementProductInBasket(String productId,
      String category) async {
    var dbClient = await db;
